...
<div class="row">
 <div class="col-md-12">
  ...
  <form method="post" action="{{route('medicalitem.insert')}}">
   {{csrf_field()}}
   <div class="form-group">
    <span>Item ID:</span>
    <input type="text" name="item_id" class="form-control" placeholder="Item ID" value="{{$next_no->num}}" readonly="readonly" />
   </div>
   <div class="form-group">
    <span>Item Name:</span>
